...
function ProfileMenuUI:Init()
	...
	LifetimeRocash.Changed:Connect(function()
		updateHolder(RocashHolder, LifetimeRocash)
	end)
	LifetimeRebirthTix.Changed:Connect(function()
		updateHolder(RebirthTixHolder, LifetimeRebirthTix)
	end)
	LifetimeValue.Changed:Connect(function()
		updateHolder(ValueHolder, LifetimeValue)
	end)
	LifetimeCases.Changed:Connect(function()
		updateHolder(CasesHolder, LifetimeCases)
	end)
	LifetimeMaterials.Changed:Connect(function()
		updateHolder(MaterialsHolder, LifetimeMaterials)
	end)
	LifetimeRobuxSpent.Changed:Connect(function()
