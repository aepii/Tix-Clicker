local rebirthUpgrades = {
	...
	R11 = {
		Name = "Increase Tix Per Second";
		Cost = 2;
		Modifier = 1.35;
		Limit = 100;
		RewardType = "RebirthTixPerSecond";
		Initial = 0;
		Reward = 10;
		Type = "Multiply";
		InitialMessage = "Current Tix Per Second : &";
		RewardMessage = "Increase Tix Per Second by 10%!";
		Image = "rbxassetid://";
		ID = "R11"
	};
	R12 = {
		Name = "Increase Auto Convert Tix";
		Cost = 2;
		Modifier = 1.35;
		Limit = 50;
		RewardType = "RebirthAutoTixConvert";
		Initial = 0;
		Reward = 1;
		Type = "Multiply";
		InitialMessage = "Current Tix Per Second Converted: &";
		RewardMessage = "Increase Tix Per Second Converted by 1%!";
		Image = "rbxassetid://";
		ID = "R12"
	};
	R11 = {
