...
local EquipFrame = AccessoryInventory.CollectibleEquipFrame
...
local function updateEquipFrame()
    local ID = Player.ReplicatedData.CollectibleAccessories[GUID.Value].Value
    local accessory = CollectibleAccessories[ID]
    
    local taggedName = TemporaryData:CalculateCollectibleTag(Player, GUID.Value)
    ...
    ButtonStatus:CollectibleAccessoryInventory(Player, GUID.Value, EquipButton)
end
