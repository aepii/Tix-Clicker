...
local OpenUI = PlayerGui:WaitForChild("CollectibleCaseOpenUI")
...
local RareRewardSound = Sounds:WaitForChild("RareRewardSound")
...
local function showWinner(winner)
    SoundService:PlayLocalSound(RareRewardSound)
    ...
    UI.Enabled = true
    OpenCollectibleCaseAnimRemote:FireServer()
end
...
OpenCollectibleCaseAnimRemote.OnClientEvent:Connect(function(caseID, winner)
